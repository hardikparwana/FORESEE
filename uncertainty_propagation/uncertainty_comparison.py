...
if 1:
    ...
    ax14.set_xlabel("x(1)")
    ax14.set_ylabel("x(2)")
    mc_mu14, foresee_mu14, pilco_mu14, mc_cov14, foresee_cov14, pilco_cov14, time14_1, time14_2 = compare_predictions( ax14, horizons = 6, num_particles = 500, expanded_only = False )
    fig14.savefig("fig14.png")

    fig24, ax24 = plt.subplots(1, 1)
    ax24.set_xlabel("x(1)")
    ax24.set_ylabel("x(2)")
    mc_mu24, foresee_mu24, pilco_mu24, mc_cov24, foresee_cov24, pilco_cov24, _ , _  = compare_predictions( ax24, horizons = 6, num_particles = 500, expanded_only = True )
