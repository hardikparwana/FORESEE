...
from cartpole_new2.cartpole_policy import policy, policy_grad, random_exploration, Sum_of_gaussians_initialize, random_policy
...
# Set up environment
exp_name = "cartpole_new_rl2_test1"
...
n_restarts = 3#50#100
iter_adam = 2000#4000
adam_start_learning_rate = 0.02#0.05#0.001 #0.02 maybe needs more iterations. with 1000, 0.05 performs better
