...
""" 
File that loads the logs and test the final policy obtained with MC-PILCO4PMS in the simualted cart-pole system with partially measurable state
"""
...
for i in range(num_test):
    meas_states, input_samples, noiseless_samples, noisy_samples = PL_obj.system.rollout(s0=initial_state,
